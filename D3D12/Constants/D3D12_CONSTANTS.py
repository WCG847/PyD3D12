...
D3D12_16BIT_INDEX_STRIP_CUT_VALUE = 0xFFF

D3D12_32BIT_INDEX_STRIP_CUT_VALUE = 0xFFFFFFF

D3D12_8BIT_INDEX_STRIP_CUT_VALUE = 0xF

D3D12_APPEND_ALIGNED_ELEMENT = 0xFFFFFFF
...
D3D12_DEFAULT_SAMPLE_MASK = 0xFFFFFFF
...
D3D12_DEFAULT_STENCIL_READ_MASK = 0xF

D3D12_DEFAULT_STENCIL_REFERENCE = 0

D3D12_DEFAULT_STENCIL_WRITE_MASK = 0xF
...
D3D12_DESCRIPTOR_RANGE_OFFSET_APPEND = 0xFFFFFFF
...
D3D12_FLOAT32_MAX = 3.402823466e38
...
D3D12_HS_FORK_PHASE_INSTANCE_COUNT_UPPER_BOUND = 0xFFFFFFF
...
D3D12_HS_JOIN_PHASE_INSTANCE_COUNT_UPPER_BOUND = 0xFFFFFFF
...
D3D12_INTEGER_DIVIDE_BY_ZERO_QUOTIENT = 0xFFFFFFF

D3D12_INTEGER_DIVIDE_BY_ZERO_REMAINDER = 0xFFFFFFF

D3D12_KEEP_RENDER_TARGETS_AND_DEPTH_STENCIL = 0xFFFFFFF

D3D12_KEEP_UNORDERED_ACCESS_VIEWS = 0xFFFFFFF
...
D3D12_MAX_POSITION_VALUE = 3.402823466e34
...
D3D12_OS_RESERVED_REGISTER_SPACE_VALUES_END = 0xFFFFFFF

D3D12_OS_RESERVED_REGISTER_SPACE_VALUES_START = 0xFFFFFFF8

D3D12_PACKED_TILE = 0xFFFFFFF
...
D3D12_PS_FRONTFACING_DEFAULT_VALUE = 0xFFFFFFF

D3D12_PS_FRONTFACING_FALSE_VALUE = 0

D3D12_PS_FRONTFACING_TRUE_VALUE = 0xFFFFFFF
...
D3D12_RESOURCE_BARRIER_ALL_SUBRESOURCES = 0xFFFFFFF
...
D3D12_SO_DDI_REGISTER_INDEX_DENOTING_GAP = 0xFFFFFFF

D3D12_SO_NO_RASTERIZED_STREAM = 0xFFFFFFF
...
D3D12_SYSTEM_RESERVED_REGISTER_SPACE_VALUES_END = 0xFFFFFFF
...
D3D12_VIDEO_DECODE_STATUS_MACROBLOCKS_AFFECTED_UNKNOWN = 0xFFFFFFF
